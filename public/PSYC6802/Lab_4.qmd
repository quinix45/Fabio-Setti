...
The `effectsize` package [@ben-shachar_etal_2025] provides functions that compute effect sizes for a wide variety of effect sizes that are commonly used in statistical analyses. 
...
<li> **Paired-samples *t*-test:** This test is used to check mean difference between *2 dependent samples*. We will soon see that this test is equivalent to a one-sample *t*-test. </li>
...
:::{.fragment fragment-index=2} 
 ...
 <p style='font-size: 30px'> Judging by the skewness and kurtosis alone, I would not be very concerned about the non normality of the data.   </p>
...
::: {.fragment fragment-index=1}
Here it is even more apparent that the distribution of the two groups does not resemble a normal distribution. 
