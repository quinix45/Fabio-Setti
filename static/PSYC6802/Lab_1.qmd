...
::: {.fragment fragment-index=2}
Let's install a package that makes opening data in R very smooth, the `rio` package [@becker_etal_2024]:
...
First, you need to install the `rmarkdown` package [@allaire_etal_2024]. 
