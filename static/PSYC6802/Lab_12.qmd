...
Today we will use the `attend` dataset from the `wooldrige` package [@Shea_Brown_2024]. See [here](https://rdrr.io/cran/wooldridge/man/attend.html){target='_blank'} for more information about the data. 
