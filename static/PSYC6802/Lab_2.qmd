...
The `dplyr` package [@wickham_etal_2023] offers a set of intuitive functions to work with data. The `dplyr` functions are great for data manipulation and data cleaning.
