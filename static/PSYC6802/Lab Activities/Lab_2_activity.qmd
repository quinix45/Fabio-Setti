...
First, click [here](https://fabio-setti.netlify.app/data/Shark_Tank_US.csv){target="_blank"} to download the `Shark_Tank_US.csv` dataset. This is data about the US version of [Shark Tank](https://en.wikipedia.org/wiki/Shark_Tank){target="_blank"}, a business reality TV show. Make sure that this file is in your working directory (you may want/need to change your working directory).
