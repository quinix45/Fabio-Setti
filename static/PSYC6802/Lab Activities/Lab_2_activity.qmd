...
First make sure that you [download](https://fabio-setti.netlify.app/data/World_happiness_2024.csv){target="_blank"} the `Shark_Tank_US.csv` dataset. This is data about the US version of [Shark Tank](https://en.wikipedia.org/wiki/Shark_Tank){target="_blank"}, a business reality TV show. Make sure that this file is in your working directory (you may want/need to change your working directory).
