---
title: "Lab 8: Interactions Between Continuous Variables"
author: "Fabio Setti"
...
format:
   revealjs:
      footer: "PSYC 7804 - Lab 8: Interactions Between Continuous Variables"
      width: 1280
      height: 720
      chalkboard: true
...
dat <- rio::import("https://fabio-setti.netlify.app/data/Attend.dta")
...
If you remember, the interpretation of the quadratic term in [Lab 7](https://fabio-setti.netlify.app/psyc7804_spring_2026/lab%207#/title-slide){target="_blank"} is *suspiciously* similar to an interaction effect 🧐 Could it be that the quadratic term is also an interaction effect? Give it some thought 🤔 
:::
:::
