---
title: "Lab 12: Regression Diagnostics"
author: "Fabio Setti"
...
format:
   revealjs:
      footer: "PSYC 7804 - Lab 12: Regression Diagnostics"
      width: 1280
      height: 720
      chalkboard: true
      slide-number: c/t 
...
<center style="padding-bottom: 12px;"> [Data]{.data-title} </center>

We will use the [2024 world happiness report](https://worldhappiness.report/ed/2024/){target="_blank"} data, which we have already used in [Lab 3](https://fabio-setti.netlify.app/psyc7804_spring_2026/lab%203#/title-slide){target='_blank'}. You can see that the rows are now named according to the country:
...
labels_react <- reactbl_col.desc(names = colnames(WH_2024),
                                 desc =  labels,
...
::: {.fragment fragment-index=4}
<li> **Cook’s *D*:** This is *very* similar to DFFITS, because it also measures how large the change in the predictions, $\hat{Y}$, would be *if* a data point was removed (influence). </li>
:::
